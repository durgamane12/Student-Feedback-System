...
function Header()
{
    ...
    $this->Cell(135);
    // Title
    $this->Cell(17,10,'KLE Dr. M.S.Sheshgiri College of Engineering and Technology, Belagum',0,1,'C');
    // Line break
    $this->Ln(9);
    // Details
...
function Footer()
{
    ...
    $this->SetFont('Arial','B',12);
    // Signature
    $this->Cell(0,0,'Head of '.$_SESSION["te_dept"]. ' Department',0,1);
    // Arial italic 8
