	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
		<header class="mdl-layout__header mdl-color--white mdl-color-text--grey-600">
			<div class="mdl-layout__header-row">
				...
				<span class="mdl-layout-title">FeedMe</span>
			...
			<div class="mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--white">
				...
				<a href="#appliedFeedbacks" class="mdl-layout__tab">Applied Feedbacks</a>
			</div>
		</header>
		...
		<!-- Subjects -->
			...
			<div class="mdl-layout__tab-panel is-active" id="appliedFeedbacks">
			
				<div class="mdl-grid">
				<h4 class="mdl-cell mdl-cell--12-col">Feedbacks Applied</h4>
					<section class="section--center mdl-card mdl-grid mdl-grid--no-spacing mdl-cell mdl-cell--8-col">
						<h4 class="mdl-cell mdl-cell--12-col">Subjects</h4>
						
						<?php
						include('../db_config.php');
						$sql = "SELECT te_username, sub_name, sub_code FROM feedbackgiven WHERE st_username = '".$_SESSION["st_username"]."'";
						$result = $conn->query($sql);
						if($result->num_rows > 0) {
						while($row = $result->fetch_assoc()){
					?>
